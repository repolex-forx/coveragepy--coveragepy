# Repolex Knowledge Graph of coveragepy/coveragepy

RDF knowledge graph data for [coveragepy/coveragepy](https://github.com/coveragepy/coveragepy), parsed by [repolex](https://repolex.ai).
...
```bash
lexq download coveragepy/coveragepy
```
...
[coveragepy/coveragepy](https://github.com/coveragepy/coveragepy)
